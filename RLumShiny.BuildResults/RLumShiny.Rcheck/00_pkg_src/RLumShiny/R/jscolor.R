...
#'
#' @description Creates a JSColor (Javascript/HTML Color Picker) widget to be used in shiny applications.
#'
...
#'
#' @seealso Other input.elements: [shiny::animationOptions], [shiny::sliderInput];
#' [shiny::checkboxGroupInput]; [shiny::checkboxInput]; [shiny::dateInput];
#' [shiny::dateRangeInput]; [shiny::fileInput]; [shiny::numericInput];
#' [shiny::passwordInput]; [shiny::radioButtons]; [shiny::selectInput],
#' [shiny::selectizeInput]; [shiny::submitButton]; [shiny::textInput]
#'
#' @examples
#' # html code
