...
> Visit the [project page](https://tzerk.github.io/RLumShiny/)!
...
It essentially only takes one argument, which is a unique keyword to
specify which app to start. See the table below for a list of available
apps and which keywords to use.
...
| Model dose rate evolution in carbonate-rich samples | RCarb | [`RCarb::model_DoseRate`](https://r-lum.github.io/RCarb/reference/model_DoseRate.html) |
...
any shiny application via
[`tooltip()`](https://tzerk.github.io/RLumShiny/reference/tooltip.md)
and
[`popover()`](https://tzerk.github.io/RLumShiny/reference/popover.md).
...
provided by the JSColor API the function
...
values and can be directly used in **R**’s base plotting functions
without requiring any format conversion.
...
![Abanico app](reference/figures/abanico.png)
...
![tooltip](reference/figures/tooltip.png)
...
![jscolor.js](reference/figures/jscolor.png)
