...
## RLumShiny 0.2.8 (Release date: 2026-08-08)
...
- App `abanico`:
  ...
  - Fix crash occurring when the custom percentile range was a
    single-digit value
    ([\#110](https://github.com/tzerk/RLumShiny/issues/110)).
...
- App `doseresponsecurve`:
  ...
  - Add support to customise line type, width and colour of the
    dose-response curve.
  - Fix crash occurring when exporting a plot
    ([\#115](https://github.com/tzerk/RLumShiny/issues/115)).
...
- App `sarCWOSL`:
  ...
  - Set the maximum number of channels according to the input file,
    instead of capping it arbitrarily at 1000
    ([\#99](https://github.com/tzerk/RLumShiny/issues/99))
...
- New application to plot a dose-response curve for luminescence data.
  Base function:
  [`Luminescence::plot_DoseResponseCurve()`](https://r-lum.github.io/Luminescence/reference/plot_DoseResponseCurve.html).
  Keyword for
...
- New application to analyse CW-OSL curve data produced by a SUERC
  ...
  function:
  [`Luminescence::analyse_portableOSL()`](https://r-lum.github.io/Luminescence/reference/analyse_portableOSL.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘portableOSL’.
...
- New application to analyse a standard SAR protocol measurements
  ...
  function:
  [`Luminescence::analyse_SAR.CWOSL()`](https://r-lum.github.io/Luminescence/reference/analyse_SAR.CWOSL.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘sarCWOSL’.
...
- Made
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md)
  ignore case differences when matching app names.

- Made warnings and errors appear as notification in the app, not only
  in the terminal
  ([\#40](https://github.com/tzerk/RLumShiny/issues/40)).
...
- New application to either estimate the number of grains on an aliquot
  ...
  [`Luminescence::calc_AliquotSize()`](https://r-lum.github.io/Luminescence/reference/calc_AliquotSize.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘aliquotsize’.
...
- New application to fit a k-component mixture to a De distribution with
  ...
  [`Luminescence::calc_FiniteMixture()`](https://r-lum.github.io/Luminescence/reference/calc_FiniteMixture.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘finitemixture’.
...
- New application to calculate the expected sample specific fraction of
  ...
  function:
  [`Luminescence::calc_Huntley2006()`](https://r-lum.github.io/Luminescence/reference/calc_Huntley2006.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘huntley2006’.
...
- New application to analyse IRSAR RF measurements on K-feldspar samples
  ...
  beyond. Base function:
  [`Luminescence::analyse_IRSAR.RF()`](https://r-lum.github.io/Luminescence/reference/analyse_IRSAR.RF.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘irsarRF’.
...
- New application to determine weighted non-linear least-squares
  ...
  [`Luminescence::fit_LMCurve()`](https://r-lum.github.io/Luminescence/reference/fit_LMCurve.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘lmcurve’.

- Added hints on file format and structure expected in each app
  ([\#45](https://github.com/tzerk/RLumShiny/issues/45)).
...
- App `surfaceexposure`:
  ...
  - Rework user interface and add tooltips
    ([\#4](https://github.com/tzerk/RLumShiny/issues/4))

- App `transformCW`:

  - Make the secondary axis label respect the scaling factor
    ([\#62](https://github.com/tzerk/RLumShiny/issues/62))
...
- App `cosmicdose`:
  ...
  - Fix crash when switching between different modes
    ([\#23](https://github.com/tzerk/RLumShiny/issues/23))

- App `doserecovery`:

  - Fix partly non-working summary statistics
    ([\#2](https://github.com/tzerk/RLumShiny/issues/2))
...
- App `histogram`:
  ...
  - Add support for breaks
    ([\#3](https://github.com/tzerk/RLumShiny/issues/3))
...
- The app `filter` did not work anymore after changes in `'shiny'`;
  fixed.

- The filter selector icons were deprecated, causing a warning in the
  terminal; fixed.

- The app `RCarb` did not work anymore after changes in `'shiny'`;
  fixed.
...
- **PREVIEW**: New application that scales the gamma dose rate
  ...
  function:
  [`Luminescence::scale_GammaDose()`](https://r-lum.github.io/Luminescence/reference/scale_GammaDose.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘scalegamma’.
...
- New application to support the new R package `RCarb`. Base function
  [`RCarb::model_DoseRate()`](https://r-lum.github.io/RCarb/reference/model_DoseRate.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘RCarb’
...
- New application to calculate the fast ratio of CW-OSL curves after
  ...
  [`Luminescence::calc_FastRatio()`](https://r-lum.github.io/Luminescence/reference/calc_FastRatio.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘fastratio’.
...
- New application to estimate the g-value from a table of Lx/Tx values
  ...
  [`Luminescence::analyse_FadingMeasurement()`](https://r-lum.github.io/Luminescence/reference/analyse_FadingMeasurement.html),
  [`Luminescence::calc_FadingCorr()`](https://r-lum.github.io/Luminescence/reference/calc_FadingCorr.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘fading’.
...
- New application to fit eq. 1 of Sohbati et al. (2012a) or eq. 12 of
  ...
  [`Luminescence::fit_SurfaceExposure()`](https://r-lum.github.io/Luminescence/reference/fit_SurfaceExposure.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
  ‘surfaceexposure’.
...
- New application to plot filter combinations along with the optional
  ...
  [`Luminescence::plot_FilterCombinations()`](https://r-lum.github.io/Luminescence/reference/plot_FilterCombinations.html).
  Keyword for
  [`app_RLum()`](https://tzerk.github.io/RLumShiny/reference/app_RLum.md):
